...
def main() -> None:
    print("== 1/12 Bronze -> Silver: catálogo completo ==")
    build_bronze_manifest.main()
    print()
    print("== 2/12 Bronze -> Silver: texto de todos los documentos ==")
    extract_texto_bronze.main()
    print()
    print("== 3/12 Bronze -> Silver: plan de mejoramiento ==")
    extract_plan_mejoramiento.main()
    print()
    print("== 4/12 Bronze -> Silver: evidencia de seguimiento ==")
    extract_seguimiento_evidencia.main()
    print()
    print("== 5/12 Bronze -> Silver: consolidado de énfasis ==")
    extract_enfasis_estudiantes.main()
    print()
    print("== 6/12 Bronze -> Silver: estado académico agregado ==")
    extract_estado_academico.main()
    print()
    print("== 7/12 Bronze -> Silver: egresados agregado ==")
    extract_egresados_agregado.main()
    print()
    print("== 8/12 Bronze -> Silver: grupos de investigación ==")
    extract_grupos_investigacion.main()
    print()
    print("== 9/12 Bronze -> Silver: seguimiento de trabajo de grado (595/695) ==")
    extract_seguimiento_tesis.main()
    print()
    print("== 10/12 Bronze -> Silver: cuadros maestros CNA (graduación/bienestar/grupos) ==")
    extract_cuadros_maestros.main()
    print()
    print("== 11/12 Silver -> Gold ==")
    build_gold.main()
    print()
    print("== 12/12 Silver -> Gold: consolidado .xlsx de Comunidad Estudiantil ==")
